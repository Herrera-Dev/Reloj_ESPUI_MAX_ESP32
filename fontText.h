...
//
// Edit: https://pjrp.github.io/MDParolaFontEditor
//
#pragma once
...
MD_MAX72XX::fontType_t ASCII_Simp[] PROGMEM = 
{
	...
	5, 35, 19, 8, 100, 98, 	// 37 - '%'
	8, 0, 1, 0, 62, 65, 65, 65, 34, 	// 38 - '&' Renombrado a Grados
	2, 4, 3, 	// 39
	3, 28, 34, 65, 	// 40 - '('
	3, 65, 34, 28, 	// 41 - ')'
	...
	3, 65, 65, 127, 	// 93 - ']'
	5, 4, 2, 1, 2, 4, 	// 94 - '^'
	1, 0, 	// 95 - '_' Renombrado a un espacio
	2, 3, 4, 	// 96 - '`'
...
MD_MAX72XX::fontType_t ASCII_Dobl[] PROGMEM ={
  0,		// 0 - 'Unused'
  0,		// 1 - 'Unused'
  0,		// 2 - 'Unused'
  0,		// 3 - 'Unused'
  ...
  5, 20, 127, 20, 127, 20,		// 35 - '#'
  5, 36, 42, 127, 42, 18,		// 36 - '$'
  7, 195, 99, 48, 24, 12, 198, 195,		// 37 - '%' Editado
  8, 3, 3, 60, 126, 195, 129, 195, 66,		// 38 - '&' Renombrado a Grados
  2, 4, 3,		// 39
  3, 28, 34, 65,		// 40 - '('
  3, 65, 34, 28,		// 41 - ')'
  5, 42, 28, 127, 28, 42,		// 42 - '*'
  ...
  2, 128, 96,		// 44 - ','
  5, 8, 8, 8, 8, 8,		// 45 - '-'
  2, 192, 192,		// 46 - '.' Editado
  5, 32, 16, 8, 4, 2,		// 47 - '/'
  6, 126, 255, 129, 129, 255, 126,		// 48 - '0' Editado
  4, 130, 255, 255, 128,		// 49 - '1' Editado
  6, 194, 227, 177, 153, 143, 134,		// 50 - '2' Editado
  6, 66, 195, 129, 153, 255, 102,		// 51 - '3' Editado
  6, 56, 60, 38, 35, 255, 255,		// 52 - '4' Editado
  6, 79, 207, 137, 137, 249, 113,		// 53 - '5' Editado
  6, 126, 255, 137, 137, 251, 114,		// 54 - '6' Editado
  6, 1, 1, 241, 249, 15, 7,		// 55 - '7' Editado
  6, 118, 255, 137, 137, 255, 118,		// 56 - '8' Editado
  6, 78, 223, 145, 145, 255, 126,		// 57 - '9' Editado
  1, 36,		// 58 - ':' Editado
  2, 128, 104,		// 59 - ';'
  4, 8, 20, 34, 65,		// 60 - '<'
  5, 20, 20, 20, 20, 20,		// 61 - '='
